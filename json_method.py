...
page_url = 'https://zh.airbnb.com/api/v2/explore_tabs?version=1.3.9&satori_version=1.0.12' \
           '&_format=for_explore_search_web&experiences_per_grid=20&items_per_grid=18' \
           '&guidebooks_per_grid=20&auto_ib=true&fetch_filters=true&has_zero_guest_treat' \
           'ment=true&is_guided_search=true&is_new_cards_experiment=true&luxury_pre_launch=' \
           'false&query_understanding_enabled=false&show_groupings=true&supports_for_you_v3=' \
           'true&timezone_offset=480&client_session_id=7dc7ccb0-c771-4075-ae1b-bf1d878eaebd&ma' \
           'p_toggle=true&metadata_only=false&is_standard_search=true&refinement_paths%5B%5D=%2F' \
           'homes&selected_tab_id=home_tab&allow_override%5B%5D=&s_tag=S8WmeQu0&screen_size=large' \
           '&query=shanghai&_intents=p1&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&currency=CNY&locale=zh'
for i in range(12):
...
for page in range(2, 5):
    ...
    page_url = 'https://zh.airbnb.com/api/v2/explore_tabs?version=1.3.9&satori_version=1.0.12&_format=for_exp' \
               ...
               'nt=true&luxury_pre_launch=true&query_understanding_enabled=false&show_groupings=true&supports_f' \
               'or_you_v3=true&timezone_offset=480&client_session_id=7dc7ccb0-c771-4075-ae1b-bf1d878eaebd&map_to' \
               'gle=true&metadata_only=false&is_standard_search=true&refinement_paths%5B%5D=%2Fhomes&selected_ta' \
               'b_id=home_tab&allow_override%5B%5D=&s_tag=S8WmeQu0&section_offset=7' \
               '&items_offset=' + str(18*(page-1)) + '&last_search_session_id=4ea4882c-fe93-4aa0-b111-e0114cfc161c' \
               '&federated_search_session_id=2e09d79e-c1e3-4763-86af-076adc9e66a9&screen_size' \
               '=large&query=shanghai&_intents=p1&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&currency=CNY&locale=zh'
    for i in range(18):
